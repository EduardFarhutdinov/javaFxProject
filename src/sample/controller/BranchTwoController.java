...
public class BranchTwoController {
...
//        fio_agent.setCellValueFactory(new PropertyValueFactory<>("fio_agent"));
    ...
    public void buttonOtchetOnAction(ActionEvent event) {
        String query = "select sum(insurance_payment) from main_office.public.dogovor where branch='B2'";
        int sum= 0;
...
//              e.printStackTrace();
    ...
    void buttonLoadDogovorOnAction() {
        ...
        String query = "select id_договора" +
                ...
                "id_auto," +
                "pay" +
                " from main_office.public.dogovor where branch='B2'";
